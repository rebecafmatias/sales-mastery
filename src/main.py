...
# Group sales by date:
# Create a dictionary where the keys are the dates and the values are lists of sales.
...
for i in sales:
    ...
    for j in customers:
        ...
        if id_customer == j["id_customer"]:
            sales_dic_with_customers_information.update(
                {"client_name": client_name, "client_email": client_email}
            )
            sales_list_with_customers_information.append(
                sales_dic_with_customers_information
            )
